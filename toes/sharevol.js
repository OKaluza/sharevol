...
scale:[getSearchVariable("dx",1),getSearchVariable("dy",1),getSearchVariable("dz",1)]},props.url&&loadTexture()):a="default.json");a&&($("status").innerHTML="Loading params...",ajaxReadFile(decodeURI(a),loadData,!0))}function loadStoredData(a){if(localStorage[a])try{props=JSON.parse(localStorage[a])}catch(b){alert("parse error: "+b.message),localStorage[a]=null}}
